"""Herramientas para simular la vida diaria en la Universidad Panamericana.

Este módulo proporciona un pequeño motor de simulación 100 % Python pensado
para experimentar con el proyecto ``TACHI``. Incluye:
...
No se requiere ningún componente HTML ni dependencias externas.
"""
